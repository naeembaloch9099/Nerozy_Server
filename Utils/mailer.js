...
// Build transport options for nodemailer SMTP
...
if (smtpService) {
  ...
  console.log(`Using ${smtpService} for email delivery`);
} else {
  transportOptions = {
    host: smtpHost,
    port: smtpPort,
  ...
  console.log(`Using SMTP for email delivery (${smtpHost}:${smtpPort})`);
}
...
// Only verify SMTP transporter if SEND_EMAILS is enabled
